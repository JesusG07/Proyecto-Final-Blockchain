...
contract("Contacts", () => {
    ...
    it("Contacts created successfully", async () => {
        // Add 1 contact
        const firstNameExample = "Aracely";
        const lastNameExample = "Ramos";
        const telephoneNumberExample = "1234567890";
        const emailExample = "aracely@algo.com";
    ...
    it("Contacts updated successfully", async () => {
        // Add 1 contact
        const oldFirstNameExample = "Aracely";
        const oldLastNameExample = "Ramos";
        const oldTelephoneNumberExample = "1234567890";
        const oldEmailExample = "aracely@algo.com";
        ...
        // Update 2nd contact
        const newFirstNameExample = "Jesus";
        const newLastNameExample = "Esteban";
        const newTelephoneNumberExample = "0987654321";
        const newEmailExample = "Jesus@algo.com";
